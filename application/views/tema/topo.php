...
<body onLoad="initTimer();">
  ...
  <div id="user-nav" class="navbar navbar-inverse">
    <ul class="nav">
      ...
      <li class="pull-right"><a href="https://danieltecnologia.com" target="_blank"><i class="fas fa-asterisk"></i> <span class="text">Versão:
  ...
  <div id="sidebar"> <a href="#" class="visible-phone"><i class="fas fa-list"></i> Menu</a>
    <ul>
      <li class="<?php if (isset($menuPainel)) {
                    echo 'active';
                  }; ?>"><a href="<?php echo base_url() ?>index.php"><i class="fas fa-home"></i> <span>Dashboard</span></a></li>
  ...
  <!--Footer-part-->
  <div class="row-fluid">
    <div id="footer" class="span12"> <a href="https://danieltecnologia.com" target="_blank">
        <?php echo date('Y'); ?> &copy; MAP OS - DanielTECH </a></div>
  </div>
  <!--end-Footer-part-->
